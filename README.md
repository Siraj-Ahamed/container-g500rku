...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-g500rku.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-g500rku.containers.anotherwebservice.com/
...
```
git clone git@github.com:Siraj-Ahamed/container-g500rku.git
cd container-g500rku
```
...
```
docker attach container-g500rku
```
